...
docker_container 'openid-staging-website' do
  ...
  env [
    ...
    "SECRET_KEY_BASE=#{openid_secrets['staging']['secret_key_base']}",
    "BRAINTREE_ACCESS_TOKEN=#{openid_secrets['staging']['braintree_access_token']}",
    "RECAPTCHA_SITE_KEY=#{openid_secrets['staging']['recaptcha_site_key']}",
    "RECAPTCHA_SECRET_KEY=#{openid_secrets['staging']['recaptcha_secret_key']}",
...
docker_container 'openid-production-website' do
  ...
  env [
    ...
    "BRAINTREE_ACCESS_TOKEN=#{openid_secrets['production']['braintree_access_token']}",
    "RECAPTCHA_SITE_KEY=#{openid_secrets['production']['recaptcha_site_key']}",
    "RECAPTCHA_SECRET_KEY=#{openid_secrets['production']['recaptcha_secret_key']}",
    'HELLO_ISSUER=https://issuer.hello.coop',
