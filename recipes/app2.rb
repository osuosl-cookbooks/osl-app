...
systemd_service 'iam-staging' do
  ...
  service do
    ...
    exec_start '/home/iam-staging/.rvm/bin/rvm 2.3.0 do bundle exec unicorn -l '\
...
systemd_service 'iam-production' do
  ...
  service do
    ...
    exec_start '/home/iam-production/.rvm/bin/rvm 2.3.0 do bundle exec unicorn -l '\
    '8084 -c config/unicorn.rb -E deployment -D'
  end
end
