...
cookbook 'osl-nginx', git: 'git@github.com:osuosl-cookbooks/osl-nginx', branch: 'zwall/nginx-update'
cookbook 'osl-nodejs', git: 'git@github.com:osuosl-cookbooks/osl-nodejs'
